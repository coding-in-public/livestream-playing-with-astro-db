import { c as createAstro, d as createComponent, r as renderTemplate, e as addAttribute, m as maybeRenderHead, s as spreadAttributes, f as renderSlot, g as renderComponent, A as AstroError, h as UnknownContentCollectionError, i as renderUniqueStylesheet, j as renderScriptElement, k as createHeadAndContent, u as unescapeHTML, l as renderHead } from '../astro_Bg9zxLL4.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                           */
/* empty css                                                                   */
...
const db = await createRemoteDatabaseClient(process.env.ASTRO_STUDIO_APP_TOKEN ?? "ec2b35e729e7939c55d06c519e5a7378f5b8ff34:twbsr61gmbaz8yxn2dpisyxt5kl6", {"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://example.com", "ASSETS_PREFIX": undefined}.ASTRO_STUDIO_REMOTE_DB_URL ?? "https://db.services.astro.build");
const Like = asDrizzleTable("Like", { "columns": { "id": { "type": "text", "schema": { "unique": false, "deprecated": false, "name": "id", "collection": "Like", "primaryKey": false, "optional": false } }, "likes": { "type": "number", "schema": { "unique": false, "deprecated": false, "name": "likes", "collection": "Like", "primaryKey": false, "optional": false } } }, "deprecated": false }, false);
...
}, "/Users/chris.pennington/cip/LiveStreams/playing-with-astro-db/src/components/BaseHead.astro", void 0);
...
}, "/Users/chris.pennington/cip/LiveStreams/playing-with-astro-db/src/components/HeaderLink.astro", void 0);
...
}, "/Users/chris.pennington/cip/LiveStreams/playing-with-astro-db/src/components/Header.astro", void 0);
...
}, "/Users/chris.pennington/cip/LiveStreams/playing-with-astro-db/src/components/Footer.astro", void 0);
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/first-post.md": () => import('../first-post_DhIdsBTz.mjs'),"/src/content/blog/markdown-style-guide.md": () => import('../markdown-style-guide_Cgf0e2hU.mjs'),"/src/content/blog/second-post.md": () => import('../second-post_DvFWZwGF.mjs'),"/src/content/blog/third-post.md": () => import('../third-post_B66pIsW5.mjs'),"/src/content/blog/using-mdx.mdx": () => import('../using-mdx_D-Liw161.mjs')});
...
}, "/Users/chris.pennington/cip/LiveStreams/playing-with-astro-db/src/components/FormattedDate.astro", void 0);
...
const $$LikeCounter = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<button id="like-btn"${addAttribute(like.id, "data-id")} class="like-btn" aria-label="Likes for post" data-astro-cid-aze7hv4s> <div id="likes-span" data-astro-cid-aze7hv4s>${like.likes}</div> <span data-astro-cid-aze7hv4s>🔥❤️‍🔥</span> </button>  `;
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let likes = await db.select().from(Like).where(eq(Like.id, slug));
  if (likes.length === 0) {
    likes = [
      {
        id: slug,
...
export { $$FormattedDate as $, Like as L, SITE_TITLE as S, ____slug_ as _, $$BaseHead as a, $$Header as b, $$Footer as c, db as d, SITE_DESCRIPTION as e, $$HeaderLink as f, getCollection as g };
